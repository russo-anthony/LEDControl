...
#define CYBLE_LEDSERVICE_SERVICE_INDEX   (0x00u) /* Index of ledService service in the cyBle_customs array */
#define CYBLE_LEDSERVICE_PWMCOMPARE_CHAR_INDEX   (0x00u) /* Index of pwmCompare characteristic */
#define CYBLE_LEDSERVICE_PWMCOMPARE_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_LEDSERVICE_SERVICE_HANDLE   (0x0010u) /* Handle of ledService service */
#define CYBLE_LEDSERVICE_PWMCOMPARE_DECL_HANDLE   (0x0011u) /* Handle of pwmCompare characteristic declaration */
#define CYBLE_LEDSERVICE_PWMCOMPARE_CHAR_HANDLE   (0x0012u) /* Handle of pwmCompare characteristic */
#define CYBLE_LEDSERVICE_PWMCOMPARE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
